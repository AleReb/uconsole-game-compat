...
# Place this script in the Cuphead installation root, next to Cuphead.
# For the local v1.3.4 build, install uconsole-cuphead-pad-bridge to
# $HOME/.local/bin and keep bwrap available to avoid the joystick regression.
